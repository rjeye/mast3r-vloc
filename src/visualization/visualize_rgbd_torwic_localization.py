...
def log_to_rerun(
    ...
    intrinsics_dict = read_intrinsics(query_data_root / "intrinsics_right.txt")

    # Collect and sort RGB and depth files
    ref_rgb_files = natsorted(Path(ref_data_root / "image_right").glob("*.png"))
    # ref_depth_files = natsorted(Path(ref_data_root / "depth_right").glob("*.png"))
    query_rgb_files = natsorted(Path(query_data_root / "image_right").glob("*.png"))
    # query_depth_files = natsorted(Path(query_data_root / "depth_right").glob("*.png"))
